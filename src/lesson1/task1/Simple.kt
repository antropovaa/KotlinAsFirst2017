...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    val vershokInMeters = 4.445 / 100
    val vershoksInSagenes = sagenes * 48
    val vershoksInArshins = arshins * (48 / 3)
    val result = vershoksInArshins + vershoksInSagenes + vershoks

    return result * vershokInMeters
}
